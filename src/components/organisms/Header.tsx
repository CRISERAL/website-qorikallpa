              ...
              <ul className="flex items-center gap-8">
                {navLinks.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-sm font-black hover:text-primary-500 transition-colors tracking-wide uppercase relative group"
                    >
                      {link.label}
      ...
      <div className="lg:hidden">
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex items-center justify-between py-3">
            <button
              onClick={toggleMenu}
              className="flex items-center justify-center w-10 h-10 hover:text-primary-500 transition-colors"
        ...
        {isMenuOpen && (
          <div className="absolute top-full left-0 right-0 bg-neutral-500 shadow-lg z-50">
                ...
                {navLinks.map((link) => (
                  <li key={link.href}>
                    <Link
                      ...
                      className="block text-sm font-black hover:text-primary-500 transition-colors tracking-wide uppercase py-2"
                    >
                      {link.label}
                    </Link>
                  </li>
